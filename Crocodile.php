...
<body>
    <nav class="navbar navbar-light bg-light">
        <a class="navbar-brand mx-auto" href="Crocodile(freshwater).php">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class ="container">
            ...
            <a class="navbar-brand mb-0 h1" href="#">CROCODILE<span class="sr-only">(current)</span></a>
     ...
     <div class="jumbotron">
        ...
        <tr>
            ...
            <td width="100" align="center" bgcolor="#CCCCCC"><strong>เพิ่มในตะกร้า</strong></td>
        </tr>
  ...
  while($row = mysqli_fetch_array($result))
  {
    ...
    echo "<td align='center'><a href='Purchase.php?cro_id=$row[cro_id]&act=add'>เพิ่มลงตะกร้า</a></td>";
	echo "</tr>";
  }
  ?>
        </table>
