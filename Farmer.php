...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class ="container">
            <a class="navbar-brand mb-0 h1" href="#">ข้อมูลราคาจระเข้<span class="sr-only">(current)</span></a>
            <a class="navbar-brand" href="Report.php">Report</a>               
     ...
     <?php
        ...
        if(isset($_POST['submit'])){
            ...
            $sql = "INSERT INTO tb_crocodile (cro_id,cro_price)
            VALUES ('".$_POST["cro_id"]."','".$_POST["cro_price"]."')";
                    ...
                    <form action=""method="POST" enctype="multipart/form-data">
                        ...
                        <div class ="card-body">
                            ...
                            <label for="price"class="col-sm-3 col-form-label">Price</label>
                                <div class ="col-sm-9">
                                <input type ="text" class="form-control" id ="cro_price"name="cro_price"required>
                                </div>
                            </div>
